...
class HandoverDetails extends AbstractModel
{
    ...
    {
        return [
            'meetsCustomerExpectation' => [ 'model' => null, 'enum' => null, 'array' => false ],
            'earliestHandoverDateTime' => [ 'model' => null, 'enum' => null, 'array' => false ],
            'latestHandoverDateTime' => [ 'model' => null, 'enum' => null, 'array' => false ],
            'collectionMethod' => [ 'model' => null, 'enum' => Enum\HandoverDetailsCollectionMethod::class, 'array' => false ],
        ];
    }
    ...
    /**
     * @var Enum\HandoverDetailsCollectionMethod The type of collection for this parcel.
     */
